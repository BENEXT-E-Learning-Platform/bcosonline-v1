      ...
      <div className="max-w-6xl mx-auto flex items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center">
          <Link href="/dashboard" className="flex items-center group">
            <div className="w-8 h-8 bg-[#91be3f] rounded flex items-center justify-center mr-2 group-hover:bg-white transition-colors duration-200">
              <span className="text-[#253b74] font-bold text-lg">D</span>
            </div>
          ...
          {user ? (
            <>
              ...
              <button className="p-2 text-[#253b74] hover:text-[#91be3f] transition-colors relative">
                <Bell size={20} />
                <span className="absolute top-0 right-0 w-4 h-4 bg-[#91be3f] rounded-full text-[10px] flex items-center justify-center text-white">
                  3
                </span>
              </button>
